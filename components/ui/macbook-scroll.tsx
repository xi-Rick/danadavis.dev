...
export const MacbookScroll = ({
  ...
  // Fixed transform values for better desktop experience
  ...
  // Significantly reduced translate distance for desktop
  ...
  return (
    <div
      ref={ref}
      // Reduced minimum height for better spacing
      className="min-h-[80vh] md:min-h-[90vh] object-cover flex flex-col items-center py-0 md:py-6 justify-start flex-shrink-0 [perspective:800px] transform scale-[0.6] md:scale-100"
    >
      <motion.h2
        style={{
        ...
        className="dark:text-white uppercase text-neutral-800 text-4xl md:text-7xl font-extrabold mb-10 text-center"
      >
        {title || (
          <span>
