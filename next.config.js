...
const ContentSecurityPolicy = `
  default-src 'self';
  script-src 'self' 'unsafe-eval' 'unsafe-inline' https: analytics.umami.is cloud.umami.is *.eleavers.com *.vercel-scripts.com;
  style-src 'self' 'unsafe-inline';
  img-src * blob: data:;
  media-src *.s3.amazonaws.com localhost:3434 danadavis.dev github.com *.githubusercontent.com;
  connect-src *;
  font-src 'self';
